...
internal interface ScreenWakeController {
    fun acquire()
    fun release()
}

/** Keeps platform calls balanced even when focus and window-state events arrive repeatedly. */
internal class ScreenWakeCoordinator(private val controller: ScreenWakeController) {
...
internal fun createDesktopScreenWakeController(osName: String = System.getProperty("os.name")): ScreenWakeController = when {
