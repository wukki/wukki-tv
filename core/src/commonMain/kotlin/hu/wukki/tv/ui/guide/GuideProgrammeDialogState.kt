...
data class GuideProgrammeDialogState(
    ...
    fun reduce(event: GuideProgrammeDialogEvent): GuideProgrammeDialogTransition =
        when (event) {
            GuideProgrammeDialogEvent.LEFT, GuideProgrammeDialogEvent.RIGHT -> {
                GuideProgrammeDialogTransition(
            ...
            GuideProgrammeDialogEvent.BACK -> {
                GuideProgrammeDialogTransition(this, GuideProgrammeDialogEffect.DISMISS)
            }

            GuideProgrammeDialogEvent.CONFIRM -> {
                when (focusedAction) {
                    GuideProgrammeDialogAction.CANCEL -> {
                        GuideProgrammeDialogTransition(this, GuideProgrammeDialogEffect.DISMISS)
                    }

                    GuideProgrammeDialogAction.OPEN -> {
                        GuideProgrammeDialogTransition(
                            this,
