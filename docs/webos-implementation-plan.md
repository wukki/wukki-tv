...
- Beállítások, kedvencek és playlist-cache: verziózott IndexedDB séma, tranzakciós mentés; az első próbában a tényleges TV-s tartósságot ellenőrizni kell. EPG külön, eldobható cache, kvótahiba esetén ez üríthető először. Sérült felhasználói állapotot ne írjunk felül üressel.
