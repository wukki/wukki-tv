> Archivált technikai backlog. Az aktív paritási terv: [webos-user-stories.md](webos-user-stories.md). A készültségi állapotok történeti állítások, nem UI-paritási igazolások.
