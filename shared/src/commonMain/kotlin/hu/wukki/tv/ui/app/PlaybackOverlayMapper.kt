...
internal fun playbackOverlayData(
    ...
    recovery: hu.wukki.tv.PlaybackRecoveryState? = null,
): PlaybackOverlayData {
    val playbackStatus =
        when (playbackState) {
    ...
    return PlaybackOverlayData(
        ...
        programmeImageUrl =
            currentProgramme?.imageUrl?.takeIf {
        ...
        playbackStatus = playbackStatus.takeIf { recovery == null },
        recovery = recovery,
        playbackError = playbackState == PlaybackState.ERROR,
        buffering =
            PlaybackBufferingOverlay(tr(language, "playback.buffering"))
