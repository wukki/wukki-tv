...
object Localizer {
    ...
    ): String = platformText(language, key, arguments.toList())
...
fun tr(
    ...
    key: String,
    vararg arguments: Any?,
): String = Localizer.text(language, key, *arguments)
...
expect fun platformGuideDateLabel(
    language: AppLanguage,
    millis: Long,
    pattern: String,
): String

expect fun platformGuideTime(
    millis: Long,
    dayOffset: Long,
    hour: Int? = null,
): Long
