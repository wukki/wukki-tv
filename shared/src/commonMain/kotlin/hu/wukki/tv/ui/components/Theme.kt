...
val WukkiColorScheme: ColorScheme = darkColorScheme(
    ...
    surfaceTint = WukkiColors.primary,
    surfaceDim = WukkiColors.background,
    surfaceBright = WukkiColors.surfaceInput,
    surfaceContainerLowest = WukkiColors.navigationBackground,
    surfaceContainerLow = WukkiColors.backgroundRaised,
    surfaceContainer = WukkiColors.surface,
    surfaceContainerHigh = WukkiColors.surfaceRaised,
    surfaceContainerHighest = WukkiColors.surfaceInput,
    inverseSurface = WukkiColors.textPrimary,
    inverseOnSurface = WukkiColors.background,
    inversePrimary = WukkiColors.primary,
