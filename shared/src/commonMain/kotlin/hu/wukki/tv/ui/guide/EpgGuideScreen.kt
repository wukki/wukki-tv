...
fun EpgGuideScreen(
    ...
    BoxWithConstraints(modifier) {
        ...
        val viewport =
            remember(timeline, state.horizontalScroll.value, state.viewportWidthPx, minuteWidthPx) {
                guideViewport(
                    timeline = timeline,
        ...
        LaunchedEffect(channels.map { it.id }, timeline, dataVersion) { state.initialise(data, channels, timeline) }
