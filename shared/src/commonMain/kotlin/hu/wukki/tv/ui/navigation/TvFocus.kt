...
fun Key.liveImmediateChannelDelta(): Int? =
    when (this) {
...
fun Key.livePreviewEvent(): LiveChannelPreviewEvent? =
    when (this) {
...
fun Key.toAppRemoteKey(): AppRemoteKey =
    AppRemoteKey(
        ...
        channelDelta = liveImmediateChannelDelta(),
        preview = livePreviewEvent(),
        digit =
            when (this) {
