...
OUT = Path(os.environ.get('PARITY_OUTPUT', ROOT / 'docs/webos-parity/v1/screenshots/android-tv'))
SCENARIOS = ['live', 'live-empty', 'channels', 'search', 'no-results', 'no-data', 'favorites', 'recent', 'guide', 'guide-details', 'settings', 'settings-playback', 'settings-epg', 'settings-display', 'settings-parental', 'settings-playlists', 'settings-language', 'settings-about', 'quick-settings', 'offline']
